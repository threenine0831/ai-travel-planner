...
Firebase Authentication으로 로그인한 사용자가 여행지, 날짜, 예산, 인원, 관심사를 입력하면 FastAPI 백엔드가 Google AI API를 호출해 한국어 여행 일정을 생성하는 웹 프로젝트입니다. 생성된 일정은 Firestore에 공개 또는 비공개로 저장할 수 있고, 공개 일정은 커뮤니티에서 조회할 수 있습니다.
